...
<html lang="en">
  ...
  <body>  
      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
         ...
         <ul>
            ...
            <li><a href="#" class="active"><i class="fa fa-users fa-fw"></i>View Companies</a></li>
            <li><a href="preferences.php"><i class="fa fa-users fa-fw"></i>Preferences</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          ...
          <div class="templatemo-content-widget no-padding">
		  	<a href="apply.php" class="templatemo-blue-button">Apply</a>
   ...
   <td><a   class="white-text templatemo-sort-by">Work Profile</a></td>               
   <td><a class="white-text templatemo-sort-by">Ctc offered </a></td>
				  </thead>
			   </tr>
...
$sql = "SELECT * FROM plogin LIMIT $start_from, $num_rec_per_page"; 
		...
		if( $currentpage > 1 && $currentpage <= $totalpage)
			{
				...
				$prev = $currentpage-1;
				echo "<li><a  href='managecompany.php?page=".$prev."'><</a></li>";
...
$prev = $currentpage-1;
	for ($i=$prev+1; $i<=$currentpage+2; $i++){
		echo "<li><a href='managecompany.php?page=".$i."'>".$i."</a></li>";
  }
  }
	...
	{
		$nxt = $currentpage+1;
		echo "<li><a  href='managecompany.php?page=".$nxt."' >></a></li>";
	}
