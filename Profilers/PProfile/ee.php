...
<html lang="en">
 ...
 <center><h2>Approved Students List of EE</h2></center>
...
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='ee' LIMIT $start_from, $num_rec_per_page"; 
...
$connect=mysqli_connect('localhost','root','','project');
// mysql_select_db('details');
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='ee'"; 
$rs_result = mysqli_query($connect,$sql); //run the query
		...
		if( $currentpage > 1 && $currentpage <= $totalpage)
			{
				...
				$prev = $currentpage-1;
				echo "<li><a  href='ee.php?page=".$prev."'><</a></li>";
...
$prev = $currentpage-1;
	for ($i=$prev+1; $i<=$currentpage+2; $i++){
		echo "<li><a href='ee.php?page=".$i."'>".$i."</a></li>";
  }
  }
	...
	{
		$nxt = $currentpage+1;
		echo "<li><a  href='ee.php?page=".$nxt."' >></a></li>";
	}
