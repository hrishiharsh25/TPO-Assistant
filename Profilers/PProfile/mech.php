...
<html lang="en">
 ...
 <center><h2>Approved Students List of Mechanical</h2></center>
		...
		if( $currentpage > 1 && $currentpage <= $totalpage)
			{
				...
				$prev = $currentpage-1;
				echo "<li><a  href='mech.php?page=".$prev."'><</a></li>";
...
$prev = $currentpage-1;
	for ($i=$prev+1; $i<=$currentpage+2; $i++){
		echo "<li><a href='mech.php?page=".$i."'>".$i."</a></li>";
  }
  }
	...
	{
		$nxt = $currentpage+1;
		echo "<li><a  href='mech.php?page=".$nxt."' >></a></li>";
	}
