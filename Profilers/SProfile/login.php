          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li>
                  <a href="../../Homepage/index.php">Home Page</a>
                </li>
                <li>
            ...
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div>
                <?php
                  ...
                  $sql = "SELECT FirstName,LastName,Email,Branch,Sem FROM basicdetails where USN='$idd'"; 
                  $rs_result = mysqli_query ($connect,$sql); //run the query
                  $sql1 = "SELECT Name FROM slogin where USN='$idd'"; 
                  $rs_result1 = mysqli_query ($connect,$sql1); //run the query
if ($row = mysqli_fetch_assoc($rs_result)) 
{ 
  
print "<h2>".$row['FirstName']." ".$row['LastName']."</h2>"."<br>"; 
print "<h3>"."Email : ".$row['Email']."</h3>"."<br>"; 
print "<h3>"."Branch : ".$row['Branch']."</h3>"."<br>"; 
print "<h3>"."Semester : ".$row['Sem']."</h3>"."<br>"; 
...
{
  if($row1=mysqli_fetch_array($rs_result1))
  {
    print "<h2>".$row1['Name']."</h2>"."<br>"; 
  }
  print "<h3><a href='preferences.php'>Add Your Details First</a></h3>";
}
?> 
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <!-- <p>Brace yourself for the Events that will take ur breath away. Get Started and be a Part of MANIT Family</p> -->
                  </div>
                </div>
              </div>
            </div>
