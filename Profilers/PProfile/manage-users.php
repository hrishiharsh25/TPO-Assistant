			  ...
			  <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
				  ...
				  <!-- <td><a   class="white-text templatemo-sort-by">Approval Date</a></td> -->
                    ...
                    <td><a  class="white-text templatemo-sort-by">Sch No </a></td>
...
$c_id=$_SESSION['pusername'];
$sql = "SELECT * FROM plogin,basicdetails,application1 WHERE basicdetails.USN=application1.student_id AND application1.company_id=plogin.Id AND plogin.Username='$c_id'"; 
// $sql = "SELECT * FROM basicdetails,application1,plogin where application1.company_id=plogin.Id AND plogin.Username=$c_id AND basicdetails.USN=application1.student_id ORDER BY basicdetails.ApprovalDate DESC LIMIT $start_from, $num_rec_per_page"; 
