...
<html lang="en">
 ...
 <center><h2>Approved Students List of Chemical</h2></center>
...
<table class="table table-striped table-bordered templatemo-user-table">
                <thead>
				  ...
				  <a class="white-text templatemo-sort-by">First Name </a></td>
                    ...
                    <td><a class="white-text templatemo-sort-by">Scholar Number </a></td>
...
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='chemical' LIMIT $start_from, $num_rec_per_page"; 
...
$connect=mysqli_connect('localhost','root','','project');
// mysql_select_db('details');
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='chemical'"; 
$rs_result = mysqli_query($connect,$sql); //run the query
		...
		if( $currentpage > 1 && $currentpage <= $totalpage)
			{
				...
				$prev = $currentpage-1;
				echo "<li><a  href='chemical.php?page=".$prev."'><</a></li>";
...
$prev = $currentpage-1;
	for ($i=$prev+1; $i<=$currentpage+2; $i++){
		echo "<li><a href='chemical.php?page=".$i."'>".$i."</a></li>";
  }
  }
	...
	{
		$nxt = $currentpage+1;
		echo "<li><a  href='chemical.php?page=".$nxt."' >></a></li>";
	}
